...
package ysn.com.behavior.scalelayout.support_25_3_1;
...
import ysn.com.behavior.scalelayout.utils.ConvertUtils;

import static android.support.annotation.RestrictTo.Scope.LIBRARY_GROUP;
import static ysn.com.behavior.scalelayout.support_25_3_1.ViewUtils.objectEquals;
...
public class AppBarLayout extends LinearLayout {
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        /**
         * @param snapDistance 开始snap的距离，默认30dip
         */
        ...
        private int getSnapDistance(Context context) {
            return ConvertUtils.dp2px(context, snapDistance);
        }
